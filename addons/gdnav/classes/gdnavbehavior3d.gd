...
func compute_cost(from_id: int, to_id: int, astar: GDAStar3D) -> float:
...
func _compute_cost(from_id: int, to_id: int, astar: GDAStar3D) -> float:
	if from_id == to_id:
		return 0.0
	var from_pos: Vector3 = astar.get_point_position(from_id)
	var to_pos: Vector3 = astar.get_point_position(to_id)
	return from_pos.distance_to(to_pos)

# Wrapper function to be called by other objects, because
# 	behavior._some_func() is not pretty
func estimate_cost(from_id: int, to_id: int, astar: GDAStar3D) -> float:
	return _compute_cost(from_id, to_id, astar)
# Virtual function to be overridden by user when estimating
# 	navigation cost to a certain point
func _estimate_cost(from_id: int, to_id: int, astar: GDAStar3D) -> float:
	if from_id == to_id:
		return 0.0
	var from_pos: Vector3 = astar.get_point_position(from_id)
	var to_pos: Vector3 = astar.get_point_position(to_id)
...
# Wrapper function to be called by other objects, because
# 	behavior._some_func() is not pretty
func should_traverse_point(id: int, astar: GDAStar3D) -> bool:
...
func _should_traverse_point(id: int, astar: GDAStar3D) -> bool:
	return true

# Wrapper function to be called by other objects, because
# 	behavior._some_func() is not pretty
func should_traverse_point_from(from_id: int, to_id: int, astar: GDAStar3D) -> bool:
...
func _should_traverse_point_from(from_id: int, to_id: int, astar: GDAStar3D) -> bool:
	return true
